...
import cn.sibetech.core.annotation.Log;
...
public class LogAspect {
    ...
    protected void handleLog(final JoinPoint joinPoint, Log controllerLog, final Exception e, Object jsonResult) {
        try {
            ...
            ShiroUser shiroUser = SecurityContextHolder.getCurrentUser();
//            operLog.setStatus(BusinessStatus.SUCCESS.ordinal());
            ...
            assert clients != null;
            operLog.setClientSystem(clients[0]);
            operLog.setClientBrowser(clients[1]);
//            operLog.setOperIp(ip);
//            operLog.setOperUrl(request.getRequestURI());
            if (StringUtils.isNotBlank(shiroUser.getUsername())) {
                operLog.setUsername(shiroUser.getUsername());
            }
...
//            operLog.setRequestMethod(request.getMethod());
            ...
            // 保存数据库
            logOperService.saveSysLog(operLog);
        } catch (Exception exp) {
            // 记录本地异常日志
            log.error("==前置通知异常==");
     ...
     * @param operLog 操作日志
     */
    public void getControllerMethodDescription(JoinPoint joinPoint, Log log, LogOper operLog, Object jsonResult) {
//        // 设置action动作
...
//        }
     ...
     * @param operLog 操作日志
     */
    private void setRequestValue(JoinPoint joinPoint, LogOper operLog) {
